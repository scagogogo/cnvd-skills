...
require (
	// 私有仓库依赖，配置GOPRIVATE拉取，申请权限找 CC111001100@qq.com
	github.com/JSREP/go-jsl-sdk v0.0.0-20230508093340-42e51dd47227
...
require (
	...
	github.com/crawler-go-go-go/go-requests v0.0.0-20230509025153-d3fa20897bd3 // indirect
